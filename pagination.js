...
//   // Render the pet list and pagination for the first page
//   renderPetListAndPagination(petInfoList, 1, totalPages);
// });
...
//   if (petInfo.token !== localStorage.getItem("token")) {
...
//     renderPetListAndPagination(petInfoList, page, totalPages);
//   }
// }
